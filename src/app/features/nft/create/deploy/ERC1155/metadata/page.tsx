...
export default function ERC1155MetadataSetup() {
  ...
  const handleContinue = () => {
    ...
    router.push('/nft/create/deploy/ERC1155/confirm');
  };
    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      <div className="text-center mb-10">
        ...
        <p className="text-oracle-white/70 max-w-2xl mx-auto">
          Configure the metadata and settings for your ERC1155 NFT collection.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
          ...
          {/* Default Quantity - Specific to ERC1155 */}
          <FormField
            label="Default Edition Size"
            ...
            onChange={handleInputChange}
            required
            tooltip="The default number of copies that will be minted for each NFT in this collection."
          />
        ...
        <div className="bg-sinister-black/40 border border-oracle-orange/20 rounded-xl p-6 lg:sticky lg:top-8 h-fit">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-oracle-white mb-2">Collection Information</h3>
              <div className="bg-ancient-wisdom/10 rounded-lg p-4">
                <div className="flex justify-between mb-2">
                  <span className="text-sm text-oracle-white/60">Edition Size:</span>
                  <span className="text-sm text-oracle-white">{formData.defaultQuantity || "100"}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-ancient-wisdom/10 rounded-lg p-4">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm text-oracle-white">ERC-1155</span>
                </div>
                <div className="flex justify-between">
